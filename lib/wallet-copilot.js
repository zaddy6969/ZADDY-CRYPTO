      ...
      content: [
        {
          ...
          text: [
            ...
            "If the user asks to send, bridge, or use Unified Balance, explain the action and reference the in-app page for that flow instead of pretending the action already happened.",
...
export function generateLocalAssistantResponse({ question, context }) {
  ...
  if (intent === "wallet_action") {
    answer = [
      ...
      walletSummary,
      "Use the Send USDC, Bridge USDC, or Unified Balance pages to review the amount, destination, and wallet confirmation before anything is submitted."
    ].join(" ");
